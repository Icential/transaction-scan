...
images = ["data/digits/len1.png", "data/digits/len2.png", "data/digits/len3.png", "data/digits/len4.png", "data/digits/len5.png", "data/digits/len6.png", "data/digits/len7.png", "data/digits/len8.png", "data/digits/len9.png", "data/digits/len10.png"]
...
for c in range(len(images)):
    ...
    print(f"\nLength {c+1} Time Elapsed: {time.time() - start_time:.3f}s")
